      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-4">
          <a
            ...
            onClick={() => track('whatsapp_click', { location: 'navbar-desktop' })}
          ...
          <BookButton size="sm" location="navbar-desktop" />
        </div>
            ...
            <div className="flex flex-col gap-1 mt-4">
              ...
              <div className="mt-6 px-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  onClick={() => { track('whatsapp_click', { location: 'navbar-mobile' }); setOpen(false) }}
              ...
              <div className="mt-6 px-4">
                <BookButton size="md" className="w-full text-center" location="navbar-mobile" />
              </div>
            </div>
          </SheetContent>
        </Sheet>
