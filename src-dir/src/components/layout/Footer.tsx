          ...
          <div>
            <div className="flex items-center gap-1 mb-4">
              ...
              <span className="text-sm font-medium text-white/80">
                Gonstead Chiropractic @ Rimbayu
              </span>
              <span className="w-1.5 h-1.5 rounded-full bg-sage ml-0.5" />
            </div>
            <p className="text-sm text-white/60 leading-relaxed max-w-xs mb-6">
              Your trusted Gonstead chiropractor in Rimbayu, delivering precise spinal adjustments for lasting pain relief and whole-body wellness.
            </p>
            <a
              href={WHATSAPP_URL}
              target="_blank"
            ...
            <a
              href="https://www.instagram.com/thrivechiropractic.my"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 text-sm text-white/60 hover:text-[#E4405F] transition-colors ml-4"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
